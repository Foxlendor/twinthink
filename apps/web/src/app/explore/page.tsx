    ...
    <main style={{ minHeight: '100vh', background: 'transparent', padding: '4rem 1.5rem', color: '#111827' }}>
      <div style={{ maxWidth: '1120px', margin: '0 auto' }}>
        ...
        <div style={{ marginBottom: '4rem' }}>
          <h1 className="ink-text font-serif" style={{ fontSize: '2.5rem', fontWeight: 800, marginBottom: '1rem', display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
            <Compass size={36} color="#111827" />
            Explore Public Records<span className="ink-dot">.</span>
          </h1>
